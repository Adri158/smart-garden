...
class ChatController extends ApiController
{
    ...
    public function chat(Request $request): StreamedResponse|\Illuminate\Http\JsonResponse
    {
        ...
        $apiKey = $_sgv ? env('OPENAI_API_KEY') : null;
        if (!$apiKey) {
